...
void AuraApplication::_HandleEffect(uint8 effIndex, bool apply)
{
    ...
    // 检查当前光环是否为命令怒吼或小鬼血之契印//还有天怒图腾和元素之誓
    bool isCommandingShoutOrBloodPact = (aurEff->GetSpellInfo()->Id == 47440 || aurEff->GetSpellInfo()->Id == 47439 || aurEff->GetSpellInfo()->Id == 469 || aurEff->GetSpellInfo()->Id == 27268 ||
        aurEff->GetSpellInfo()->Id == 51470 || aurEff->GetSpellInfo()->Id == 57663 || aurEff->GetSpellInfo()->Id == 57662 || aurEff->GetSpellInfo()->Id == 57660 || aurEff->GetSpellInfo()->Id == 57658);
